...
MyGame = ig.Game.extend({
	...
	init: function() {
        this.loadLevel(LevelSecondspacelevel );
        // Bind keys
	...
	draw: function() {
        ...
        if(this.instructText){
            ...
            this.instructText.draw( 'Left/Right Moves, X Jumps, C Fires, SPACE Boost Jumps.', x, y, ig.Font.ALIGN.CENTER );
        }
        if(this.showStats){
        ...
        this.livesText.draw("Health: " + player.health,5, 5);
        this.livesText.draw("Lives:", 5,35);
        for(var i=0; i < this.lives; i++)
            this.lifeSprite.draw(((this.lifeSprite.width + 5) * i)+90, 30);
        this.livesText.draw("Boosts:", 5,65);
